...
public enum CodeType {
     ...
     */
    GovInvalidVotingPower(210), UNRECOGNIZED(-1), ;
    ...
    public static CodeType forNumber(int value) {
        switch (value) {
            ...
            case 101:
                return BaseDuplicateAddress;
            case 102:
                return BaseEncodingError;
            case 103:
                return BaseInsufficientFees;
            case 104:
                return BaseInsufficientFunds;
            case 105:
                return BaseInsufficientGasPrice;
            case 106:
                return BaseInvalidInput;
            case 107:
                return BaseInvalidOutput;
            case 108:
                return BaseInvalidPubKey;
            case 109:
                return BaseInvalidSequence;
            case 110:
                return BaseInvalidSignature;
            case 111:
                return BaseUnknownAddress;
            case 112:
                return BaseUnknownPubKey;
            case 113:
                return BaseUnknownPlugin;
            case 201:
                return GovUnknownEntity;
            case 202:
                return GovUnknownGroup;
            case 203:
                return GovUnknownProposal;
            case 204:
                return GovDuplicateGroup;
            case 205:
                return GovDuplicateMember;
            case 206:
                return GovDuplicateProposal;
            case 207:
                return GovDuplicateVote;
            case 208:
                return GovInvalidMember;
            case 209:
                return GovInvalidVote;
            case 210:
                return GovInvalidVotingPower;
            default:
                return null;
        }
    }
